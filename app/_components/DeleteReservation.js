...
function DeleteReservation({ bookingId }) {
  ...
  function handleDelete() {
    if (confirm("Are you sure you want to delete this reservation"))
      startTransition(() => deleteGuestReservation(bookingId)); // in this way we wrap // in react we use in heavy state transition but in next js we are using for server action
  }
  return (
    <button
